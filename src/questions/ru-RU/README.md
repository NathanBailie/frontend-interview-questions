<div align="center">
  <h1>⚡ Вопросы для интервью фуллстэк-разработчика</h1>
</div>

<p style="font-size: 16px">
Этот репозиторий содержит тщательно подобранные вопросы, охватывающие ключевые аспекты фуллстэк-разработки. Он может быть полезен как для подготовки к собеседованию фуллстэк-разработчика, так и для его проведения 🎯
</p>
...
- ![Дизайн систем](../../../src/assets/icons/icons-for-main-readme/system-design.png) [Дизайн систем](./system-design.md)
